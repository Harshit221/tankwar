...
class PlayerSelection extends StatefulWidget {
  ...
  PlayerSelection({Key key, this.sharedPreferences, this.size}) : super(key: key);
                              ...
                              : () {
                                  showDialog(
                                      ...
                                      builder: (context) => AddPlayerDialog(
                                            ...
                                            availableTanks: widget.availableTanks,
                                            addPlayer: addPlayer,
                                          ));
                                },
                        ),
                          ...
                          onPressed: (widget.allPlayers.length <= 1)
                              ...
                              : () {
                                  Navigator.pushReplacement(
                                      context,
                                      MaterialPageRoute(builder: (context) => StartGameOffline(
                                        size: widget.size,
                                        allPlayer: widget.allPlayers,
                                        mode: widget.mode,
